...
import br.com.projetointegrador.cadastros.CadastroFornecedor;
...
public class ListaFornecedor extends Activity {
	public static ControleFornecedor repositorio;
	private Fornecedor clickList;
	...
	public static String informacao = new String("Informação: " +
			...
			"cadastrar os fornecedores que trabalham com " +
			"vocẽ. Ex: Avon, Natura");
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listaView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, final int arg2, long arg3) {
				clickList = (Fornecedor) arg0.getItemAtPosition(arg2);
				// Alerta
				// Monta a view
				...
				builder = new AlertDialog.Builder(ListaFornecedor.this);
		...
		textView.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before, int count) {
				...
				listaView.setAdapter(new ArrayAdapter<Fornecedor>(ListaFornecedor.this, android.R.layout.simple_spinner_item, lista));
			}
	...
	public void atualizarLista() {
		...
		textView.setAdapter(new ArrayAdapter<Fornecedor>(ListaFornecedor.this, android.R.layout.simple_dropdown_item_1line, lista));
		listaView.setAdapter(new ArrayAdapter<Fornecedor>(ListaFornecedor.this, android.R.layout.simple_spinner_item, lista));
	}

	public void inserir(View v) {
		startActivity(new Intent(ListaFornecedor.this, CadastroFornecedor.class));
	}

	public void alterar(View v) {
		startActivityForResult(new Intent(ListaFornecedor.this, CadastroFornecedor.class).putExtra(Fornecedor.colunas[0], clickList.getId()), 1);
	...
	public void atualizarListaFornecedor() {
		repositorio = new ControleFornecedor(this);
		lista = repositorio.listarFornecedor();
	}
