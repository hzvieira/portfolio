...
public class CadastroProdutoAcessorio extends Activity {
	...
	protected void onCreate(Bundle icicle) {
		...
		setContentView(R.layout.frmcadacessorio);
	...
	private void popularGenero() {
		campoGenero.setAdapter(new ArrayAdapter<GeneroProduto>(CadastroProdutoAcessorio.this,  android.R.layout.simple_spinner_item, new ControleGeneroProduto(getApplicationContext()).listarGeneroProduto()));
	}
	...
	public void cancelar(View v) {
		onPause();
		CadastroProdutoAcessorio.this.finish();
	}
