...
public class FrmCadTipoProduto extends javax.swing.JDialog {

    public TipoProduto entidade;
    ...
    public FrmCadTipoProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                FrmCadTipoProduto dialog = new FrmCadTipoProduto(new javax.swing.JFrame(), true);
