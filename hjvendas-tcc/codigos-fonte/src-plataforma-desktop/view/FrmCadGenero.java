...
public class FrmCadGenero extends javax.swing.JDialog {

    public Genero entidade;
    ...
    public FrmCadGenero(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                FrmCadGenero dialog = new FrmCadGenero(new javax.swing.JFrame(), true);
