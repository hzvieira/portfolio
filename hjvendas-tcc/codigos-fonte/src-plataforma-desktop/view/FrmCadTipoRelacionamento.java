...
public class FrmCadTipoRelacionamento extends javax.swing.JDialog {

    public TipoRelacionamento entidade;
    ...
    public TipoRelacionamento getEntidade() {
        return entidade;
    }

    public void setEntidade(TipoRelacionamento entidade) {
    ...
    public FrmCadTipoRelacionamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(tfNome, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(msg, javax.swing.GroupLayout.DEFAULT_SIZE, 176, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                FrmCadTipoRelacionamento dialog = new FrmCadTipoRelacionamento(new javax.swing.JFrame(), true);
